...
#Creates graph figuree
fig, ax=plt.subplots(2,1, figsize=(10,12))

#Establishes KDA column calculation
KDA_df=pd.DataFrame()
...
#Calculates rolling mean and difference of mean over games played
...
#Graphs KDA and difference of KDA
